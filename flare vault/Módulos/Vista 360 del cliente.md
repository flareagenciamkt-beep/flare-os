...
Componentes: `components/clients/{strategy,notes,access,meetings,billing,production,access-tab,portal-access-card,connected-accounts-section}.tsx`. Añadida en la migración 003 (V1.1). La pestaña "recursos" (entidad `Resource`) se retiró en el recorte de módulos (`92cf0ab`).
